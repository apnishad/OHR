...
namespace Hotels.API.Migrations
{
    ...
    [Migration("20230803182205_RoomWithLocations")]
    partial class RoomWithLocations
    {
            ...
            modelBuilder.Entity("Hotels.API.Models.Rooms", b =>
                {
                    ...
                    b.Property<string>("RoomLocId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("RoomLocId1")
                        .HasColumnType("int");
