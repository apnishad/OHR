...
export class RoomTypesSummaryComponent implements OnInit {
  ...
  OnClick()
  {
      this.modalRef = this.modalService.open(RoomTypesManipComponent,{data:{roomTypevm:{id:'',name:'',basePrice:'',description:''},status:DTOStatus.NEW},ignoreBackdropClick:true});
  ...
  OnEdit(id:string)
  {
    ...
    this.rmTypeServ.GetRoomType(id).subscribe((rdata)=>{
      rmTypevm = rdata;
      console.log(rmTypevm);
      this.modalRef = this.modalService.open(RoomTypesManipComponent,{data:{roomTypevm:rmTypevm,status:DTOStatus.EDIT},ignoreBackdropClick:true});
      this.modalRef.onClose.subscribe((data:any)=>{
  ...
  OnView(id:string)
  {
    ...
    this.rmTypeServ.GetRoomType(id).subscribe((rdata)=>{
      rmTypevm = rdata;
      this.modalRef = this.modalService.open(RoomTypesManipComponent,{data:{roomTypevm:rmTypevm,status:DTOStatus.VIEW},ignoreBackdropClick:true});
    });
  }
